...
export default function ArticleDetail() {
  ...
  const { article: cmsArticle, loaded } = useArticle(slug);
  ...
  const article =
    cmsArticle ?? articles.find((a) => a.slug === slug) ?? null;
  ...
  return (
    <div className={styles.container} style={{ backgroundColor: '#D6DCDB' }}>
      ...
      <div className="w-full max-w-[1448px] mx-auto px-4 md:px-8 lg:px-16 pt-32 pb-24 mb-16">
        ...
        {/* Featured Image */}
        <div className="relative w-full max-w-[770px] mx-auto h-[516px] mb-12 bg-[#F5F5F5] overflow-hidden">
          <Image
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {relatedArticles.map((relatedArticle) => (
              <div key={relatedArticle.id} className="flex flex-col">
                <div className="relative w-full h-[269px] bg-[#D9D9D9] mb-6 overflow-hidden">
                  <Image
