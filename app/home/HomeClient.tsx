      ...
      <section className={styles.section} style={{ background: '#ffffff' }}>
        ...
        >
          <p style={{ margin: '0 0 24px 0' }}>
            {t(
              'home.why.p1',
              'How we meet uncertainty shapes more than outcomes — it shapes cultures, values, and the futures we make possible. In moments of disruption, it is easy to default to speed, certainty, or control. Yet the challenges we face today ask for something different: deeper understanding, ethical discernment, and the capacity to hold complexity without fragmenting.'
            )}
          </p>
          <p style={{ margin: '0 0 24px 0' }}>
            {t(
